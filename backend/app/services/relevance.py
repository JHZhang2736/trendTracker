...
async def _score_batch(
    ...
    prompt = (
        "对以下热搜关键词逐条判断是否与科技/金融/商业相关。\n\n"
        "相关领域：AI、大模型、芯片、电商、股市、黄金、外汇、比特币、创业、融资、政策法规\n"
        "不相关：明星八卦、综艺、影视剧、体育、社会新闻、健康养生、美食旅游\n\n"
        f"{numbered}\n\n"
        "逐条判断，相关的给分数0-100和一句话理由（20字内）。\n"
        '格式：[{"i":序号,"s":分数,"r":"理由"},...] 只含相关条目。全不相关返回[]'
    )
